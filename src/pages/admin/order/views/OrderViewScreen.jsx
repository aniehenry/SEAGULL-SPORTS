      ...
      <div className="order-details-container">
        ...
        <div className="details-card">
          ...
          <div className="card-body">
            <div className="info-row">
              ...
              <span className="info-value">{order.userId || "N/A"}</span>
            </div>
            <div className="info-row">
              <span className="info-label">Full Name:</span>
              <span className="info-value customer-name">
                {order.customerName || order.deliveryAddress?.fullName || "N/A"}
              </span>
            </div>
            <div className="info-row">
              <span className="info-label">Email Address:</span>
              <span className="info-value">
                {order.customerEmail || order.deliveryAddress?.email || "N/A"}
              </span>
            </div>
            <div className="info-row">
          ...
          <div className="card-body">
            ...
            typeof order.deliveryAddress === "object" ? (
              <div className="address-display">
                <div className="address-line recipient-name">
                  <strong>
                ...
                {(order.customerPhone || order.deliveryAddress.phone) && (
                  <div className="address-line phone">
                    📞 {order.customerPhone || order.deliveryAddress.phone}
                  </div>
                )}
              </div>
              ...
              <div className="address-display">
                <div className="address-line">{order.deliveryAddress}</div>
              </div>
            ) : (
              <div className="no-address">
                <span className="info-label">No delivery address provided</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="details-card">
          ...
          <div className="card-body">
            ...
            <div className="info-row">
              <span className="info-label">Payment Status:</span>
              <span
                className={`info-value payment-status ${(order.paymentStatus || "pending").toLowerCase()}`}
              >
        ...
        {(order.notes || order.customerNotes) && (
          <div className="details-card">
            ...
            <div className="card-body">
              <p className="notes-text">{order.notes || order.customerNotes}</p>
            </div>
          </div>
        )}

        {/* Order Timeline/Metadata Card */}
        <div className="details-card">
          <div className="card-header">
