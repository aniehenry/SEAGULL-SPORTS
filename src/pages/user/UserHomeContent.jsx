        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-section">
              ...
              <div id="about">
                <p>
                  Founded with a passion for sports excellence, SEAGULL-SPORTS
                  has been serving athletes and fitness enthusiasts for over a
                  decade. We believe that the right equipment can make all the
                  difference in achieving your athletic goals.
                </p>
                <p>
                  Our carefully curated collection features top-quality sports
                  equipment from leading brands, ensuring that whether you're a
            ...
            <div className="footer-section">
              ...
              <p>
                <strong>🎯 Mission:</strong> To provide athletes with premium
                sports equipment that enhances performance and helps achieve
                sporting excellence.
              </p>
              <p>
                <strong>👥 Team:</strong> A dedicated team of sports enthusiasts
                and experts who understand the needs of modern athletes.
              </p>
              <p>
                <strong>🌟 Values:</strong> Quality, Performance, Innovation,
            ...
            <div className="footer-section" id="contact">
              ...
              <p>
                ...
                <br />
                info@seagullsports.com
                <br />
                support@seagullsports.com
                <br />
